...
require([
    ...
    function (Map, ArcGISDynamicMapServiceLayer, FeatureLayer,
              SimpleFillSymbol, SimpleLineSymbol, SimpleMarkerSymbol,Draw,Graphic, Query,
              ready, parser, on, dom,
              Memory, locale,
              Color, declare, array,
              Grid, Selection,
...
// @formatter:on
        ...
        ready(function () {
             ...
             */
            var outFields = ["MAGNITUDE", "UTC_DATETIME","EQID","PLACE"];
            ...
            function populateGrid(results) {
                ...
                dataQuakes = array.map(results.features, function (feature) {console.log (feature)
                    return {
                        /*
